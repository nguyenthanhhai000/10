(function () {
    ...
    function ControlController($state, $localStorage, messageShow, $timeout) {
        ...
        vm.wait2 = false;
        vm.listType = [];
        var topicPublish1 = "demo";//control1
        var topicPublish2 = "control2";
        // var client = new Paho.MQTT.Client("host", port, "client_id");
        var client = new Paho.MQTT.Client("m14.cloudmqtt.com", 32733, "web_" + parseInt(Math.random() * 100, 10));
        ...
        function onMessageArrived(message) {
            ...
            if (message.destinationName == "demo") { //event1
